...
| 章节 | 内容 | 适合人群 |
|------|------|----------|
| [概览](overview.md) | SDK 在系统中的位置、术语、两层 API | 所有读者 |
...
| [入门教程](tutorials/python.md) | 跑通第一个 Python 程序 | 所有读者 |
| [Python 示例](examples/python/index.md) | 按能力的完整 Python 示例 | 应用开发 |
| [Python API 参考](reference/python/index.md) | 每个能力模块的 Python 接口参考 | 应用开发 |
